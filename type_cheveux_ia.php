...
$tableau = array ('cour', 'long', 'mi-long', 'calvitie');
...
while ($couleur_personnage2= $couleur_personnage->fetch() ) {
		...
		if ($_SESSION['type_cheveux_joueur'] == $reponse_ia) {



$update_couleur_cheveux = "UPDATE personnage p, cheveux c SET est_affiche_nj = :affiche WHERE c.ID_cheveux = p.ID_cheveux AND type_cheveux <> :ID_cheveux AND ID_partie = :partie";
...
$r = 1;
  ...
  $update_couleur_cheveux2 = "UPDATE personnage p,cheveux c SET est_affiche_nj = :affiche WHERE c.ID_cheveux = p.ID_cheveux AND type_cheveux = :ID_cheveux AND ID_partie = :partie";
